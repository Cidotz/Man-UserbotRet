...
from userbot import BOTLOG, bot
...
@register(outgoing=True, pattern=r"^\.lock ([\s\S]*)")
async def _(event):
...
@register(outgoing=True, pattern=r"^\.unlock ([\s\S]*)")
...
@register(outgoing=True, pattern=r"^\.locks$")
async def _(event):
...
@register(outgoing=True, pattern=r"^\.plock ([\s\S]*)")
async def _(event):
...
@register(outgoing=True, pattern=r"^\.punlock ([\s\S]*)")
async def _(event):
...
@register(outgoing=True, pattern=r"^\.uperm(?:\s|$)([\s\S]*)")
async def _(event):  # sourcery no-metrics
